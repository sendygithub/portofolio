          ...
          <div className="flex space-x-8">
            {[...marqueeSkills, ...marqueeSkills].map((skill, index) => (
              <motion.div
                ...
                className="flex-shrink-0 px-6 py-3 bg-white/5 border border-white/10 rounded-full text-white/80 font-medium whitespace-nowrap"
              >
                {skill}
              </motion.div>
            ))}
        ...
        >
          {skillCategories.map((category, index) => (
            <motion.div
              ...
              className={`bg-gradient-to-br ${category.gradient} p-[1px] rounded-2xl`}
            >
